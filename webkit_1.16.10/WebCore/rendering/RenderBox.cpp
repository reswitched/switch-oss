...
#if PLATFORM(WKC)
WKC_DEFINE_GLOBAL_TYPE_ZERO(OverrideSizeMap*, gOverrideContentLogicalHeightMap);
WKC_DEFINE_GLOBAL_TYPE_ZERO(OverrideSizeMap*, gOverrideContentLogicalWidthMap);
#else
...
#if PLATFORM(WKC)
WKC_DEFINE_GLOBAL_TYPE_ZERO(OverrideOptionalSizeMap*, gOverrideContainingBlockContentLogicalHeightMap);
WKC_DEFINE_GLOBAL_TYPE_ZERO(OverrideOptionalSizeMap*, gOverrideContainingBlockContentLogicalWidthMap);
#else
...
#if PLATFORM(WKC)
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(bool, RenderBox, s_hadOverflowClip);
#else
...
#else
void RenderBox::addFocusRingRects(Vector<LayoutRect>& rects, const LayoutPoint& additionalOffset, const RenderLayerModelObject* paintContainer)
{

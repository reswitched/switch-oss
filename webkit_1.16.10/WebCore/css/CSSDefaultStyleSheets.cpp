...
#else
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(RuleSet*, CSSDefaultStyleSheets, defaultStyle);
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(RuleSet*, CSSDefaultStyleSheets, defaultQuirksStyle);
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(RuleSet*, CSSDefaultStyleSheets, defaultPrintStyle);
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(unsigned, CSSDefaultStyleSheets, defaultStyleVersion);

WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(StyleSheetContents*, CSSDefaultStyleSheets, simpleDefaultStyleSheet);
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(StyleSheetContents*, CSSDefaultStyleSheets, defaultStyleSheet);
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(StyleSheetContents*, CSSDefaultStyleSheets, quirksStyleSheet);
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(StyleSheetContents*, CSSDefaultStyleSheets, svgStyleSheet);
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(StyleSheetContents*, CSSDefaultStyleSheets, mathMLStyleSheet);
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(StyleSheetContents*, CSSDefaultStyleSheets, mediaControlsStyleSheet);
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(StyleSheetContents*, CSSDefaultStyleSheets, fullscreenStyleSheet);
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(StyleSheetContents*, CSSDefaultStyleSheets, plugInsStyleSheet);
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(StyleSheetContents*, CSSDefaultStyleSheets, imageControlsStyleSheet);
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(StyleSheetContents*, CSSDefaultStyleSheets, mediaQueryStyleSheet);
#endif

...
#else
        WKC_DEFINE_STATIC_TYPE(StyleRuleKeyframe*, zeroPercentKeyframe, 0);
#endif
...
#else
        WKC_DEFINE_STATIC_TYPE(StyleRuleKeyframe*, hundredPercentKeyframe, 0);
#endif
...
#else
    static LazyNeverDestroyed<HashSet<AtomicString>> tagNames;
    if (tagNames.isNull())
        tagNames.construct([] {
#endif

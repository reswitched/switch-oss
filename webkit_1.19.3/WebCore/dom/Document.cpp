...
WKC_DEFINE_GLOBAL_CLASS_OBJ_ZERO(unsigned, ScriptDisallowedScope::LayoutAssertionDisableScope, s_layoutAssertionDisableCount);
#else
...
CustomElementNameValidationStatus Document::validateCustomElementName(const AtomicString& localName)
{
    ...
    if (annotationXmlLocalName.isNull())
        annotationXmlLocalName.construct("annotation-xml", AtomicString::ConstructFromLiteral);
#endif
#endif

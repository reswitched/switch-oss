...
namespace WKC {
    ...
    */
    typedef bool (*CanCacheToDiskProc)(const char* in_url, double in_current_age, double in_freshness_lifetime, long long in_original_content_size, long long in_aligned_content_size);
    /**
...
/**
@brief Suspends watchdog timer
@details
Suspends watchdog timer.
*/
WKC_API void WKCWebKitSuspendWatchdog();

/**
@brief Resumes watchdog timer
@details
Resumes watchdog timer.
*/
WKC_API void WKCWebKitResumeWatchdog();
/**
@brief Restart watchdog timer after shouldInterruptJavaScript() returns true
@details
Restart watchdog timer after shouldInterruptJavaScript() returns true.
*/
WKC_API void WKCWebKitRestartWatchdog();
...
public:
    ...
    */
    ...
    /**
       ...
       @return None
       @attention
       This API can't use when USE_WKC_CUSTOM_BACKFORWARD_LIST is defined.
    */
    ...
    */
    ...
    /**
       @brief Cancel vibration.
       @retval None
       @details
       Cancel vibration.
     */
    void requestCancelVibration();

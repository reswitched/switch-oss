...
void Pasteboard::read(PasteboardPlainText& text, PlainTextURLReadingPolicy, Optional<size_t> itemIndex)
{
    notImplemented();
}

void Pasteboard::read(PasteboardWebContentReader& reader, WebContentReadingPolicy, Optional<size_t> itemIndex)
{
    notImplemented();
}

...
public:
    ...
    SharedBuffer* getCacheReadBuffer() const { return m_cacheReadBuffer.get(); }
    void clearCacheReadBuffer() { m_cacheReadBuffer = nullptr; }
...
public:
    ...
    HTTPCachedResource* createHTTPCachedResource(URL &url, SharedBuffer* resourceData, ResourceRequest& request, ResourceResponse &response, Vector<std::pair<String, String>> varyingRequestHeaders, bool serverpush);
    bool addCachedResource(HTTPCachedResource *resource);
    void updateCachedResource(HTTPCachedResource *resource, SharedBuffer* resourceData, ResourceRequest& request, ResourceResponse &response, Vector<std::pair<String, String>> varyingRequestHeaders, bool serverpush);
    ...
    bool read(HTTPCachedResource *resource);

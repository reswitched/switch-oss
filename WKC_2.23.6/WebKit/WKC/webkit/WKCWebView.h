...
public:
    ...
    */
    ...
    /**
       ...
       @return None
    */
    void executeScriptIgnoringException(const char* script, bool forceUserGesture = false);
    ...
    /**
       ...
       @return None
    */
    void executeUserAgentScriptInWorldIgnoringException(DOMWrapperWorld& world, const char* script, bool forceUserGesture);

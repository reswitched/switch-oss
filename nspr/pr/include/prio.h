...
struct PRIPv6Addr {
    union {
        PRUint8  _S6_uint8[16];
        PRUint16 _S6_uint16[8];
        PRUint32 _S6_uint32[4];
        PRUint64 _S6_uint64[2];
    } _S6_un_addr;
};
#define pr_s6_addr      _S6_un_addr._S6_uint8
#define pr_s6_addr16    _S6_un_addr._S6_uint16
#define pr_s6_addr32    _S6_un_addr._S6_uint32
#define pr_s6_addr64    _S6_un_addr._S6_uint64
...
union PRNetAddr {
    struct {
#if defined(NN_NINTENDO_SDK) && !defined(WIN32) && !defined(__linux__)
        PRUint8 len;
        PRUint8 family;
#else

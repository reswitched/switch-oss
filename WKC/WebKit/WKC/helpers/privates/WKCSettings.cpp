...
{
    m_parent->core()->setSessionID(arg ? WebCore::SessionID::legacyPrivateSessionID() : WebCore::SessionID::defaultSessionID());
}

bool WKCSettings::privateBrowsingEnabled() const
{
    return m_parent->core()->sessionID()==WebCore::SessionID::legacyPrivateSessionID();
}
...
{
    WebCore::URL location(WebCore::URL(),arg);

...
#if PLATFORM(WKC)
    LayoutRect absoluteCompositeTransformedRectInternal(bool clip) const;
    LayoutRect absoluteCompositeTransformedRect(bool ignoreBorder = true) const;
    LayoutRect absoluteClippedCompositeTransformedRect(bool ignoreBorder = true) const;

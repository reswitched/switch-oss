...
#else
    static LazyNeverDestroyed<HashSet<AtomicString>> set;
    if (set.isNull())
        set.construct([] {
#endif
...
#else
    static LazyNeverDestroyed<HashSet<AtomicString>> map;
    if (map.isNull())
        map.construct(HashSet<AtomicString> {
#endif
        "American Typewriter",
        "Arial Hebrew",
        "Chalkboard",

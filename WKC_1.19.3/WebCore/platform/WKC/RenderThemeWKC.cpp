...
void RenderThemeWKC::adjustButtonStyle(StyleResolver& /*selector*/, RenderStyle& /*style*/, const Element* /*e*/) const
{
}
...
void RenderThemeWKC::adjustTextFieldStyle(StyleResolver& css, RenderStyle& style, const Element* e) const
{
...
void RenderThemeWKC::adjustTextAreaStyle(StyleResolver& css, RenderStyle& style, const Element* e) const
{
...
void RenderThemeWKC::adjustSearchFieldStyle(StyleResolver& css, RenderStyle& style, const Element* e) const
{
    adjustTextFieldStyle(css, style, e);
}
...
void RenderThemeWKC::adjustSearchFieldCancelButtonStyle(StyleResolver&, RenderStyle& style, const Element*) const
{
...
void RenderThemeWKC::adjustSearchFieldResultsDecorationPartStyle(StyleResolver& css, RenderStyle& style, const Element* e) const
{
    unsigned int width=0, height=0;
    float scale = wkcStockImageGetImageScalePeer();
...
void RenderThemeWKC::adjustSearchFieldDecorationPartStyle(StyleResolver& css, RenderStyle& style, const Element*) const
{
}
...
void RenderThemeWKC::adjustMenuListStyle(StyleResolver& selector, RenderStyle& style, const Element* e) const
{
    style.resetBorder();
    style.resetPadding();
...
void RenderThemeWKC::adjustMenuListButtonStyle(StyleResolver& selector, RenderStyle& style, const Element* e) const
{
    style.resetPadding();
...
void RenderThemeWKC::adjustSliderTrackStyle(StyleResolver& selector, RenderStyle& style, const Element* element) const
{
...
void RenderThemeWKC::adjustSliderThumbStyle(StyleResolver& selector, RenderStyle& style, const Element* e) const
{
    int index = 0;
...
void RenderThemeWKC::adjustMediaControlStyle(StyleResolver&, RenderStyle&, const Element*) const
{
}
...
void RenderThemeWKC::adjustProgressBarStyle(StyleResolver&, RenderStyle&, const Element*) const
{
}
...
void RenderThemeWKC::adjustInnerSpinButtonStyle(StyleResolver&, RenderStyle& style, const Element*) const
{

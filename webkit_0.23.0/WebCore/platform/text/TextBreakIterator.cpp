...
#else
        textLocal.text.magic = UTEXT_MAGIC;
        textLocal.text.flags = 0;
        textLocal.text.providerProperties = 0;
        textLocal.text.sizeOfStruct = sizeof(UText);
        textLocal.text.chunkNativeLimit = 0;
        textLocal.text.extraSize = 0;
        textLocal.text.nativeIndexingLimit = 0;
        textLocal.text.chunkNativeStart = 0;
        textLocal.text.chunkOffset = 0;
        textLocal.text.chunkLength = 0;
        textLocal.text.chunkContents = 0;
        textLocal.text.pFuncs= 0;
        textLocal.text.pExtra = 0;
        textLocal.text.context = 0;
        textLocal.text.p = 0;
        textLocal.text.q = 0;
        textLocal.text.r = 0;
        textLocal.text.privP = 0;
        textLocal.text.a = 0;
        textLocal.text.b = 0;
        textLocal.text.c = 0;
        textLocal.text.privA = 0;
        textLocal.text.privB = 0;
        textLocal.text.privC = 0;
#endif

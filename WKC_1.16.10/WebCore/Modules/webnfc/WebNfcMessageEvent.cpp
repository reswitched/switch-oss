...
WebNfcMessageEvent::WebNfcMessageEvent(const AtomicString& eventType, RefPtr<WebNfcMessage> message)
...
Ref<WebNfcMessageEvent> WebNfcMessageEvent::create(const AtomicString& eventType, RefPtr<WebNfcMessage> message)
{

...
public:
    ...
    virtual void dispatchMetaInitialAutofocusDidChange(const WTF::String&) const override;
    ...
    virtual void runOpenPanel(WebCore::Frame&, WebCore::FileChooser&) override;
    virtual void loadIconForFiles(const WTF::Vector<WTF::String>&, WebCore::FileIconLoader&) override;

    virtual void elementDidFocus(WebCore::Element&) override;
    virtual void elementDidBlur(WebCore::Element&) override;
    virtual void elementDidRefocus(WebCore::Element&) override;
    ...
    virtual RefPtr<WebCore::DisplayRefreshMonitor> createDisplayRefreshMonitor(WebCore::PlatformDisplayID) const override;
#endif
    ...
    virtual bool supportsVideoFullscreenStandby() override;

#if ENABLE(VIDEO)
    virtual void enterVideoFullscreenForVideoElement(WebCore::HTMLVideoElement&, WebCore::HTMLMediaElementEnums::VideoFullscreenMode, bool standby) override;
    virtual void setUpPlaybackControlsManager(WebCore::HTMLMediaElement&) override {}
    virtual void clearPlaybackControlsManager() override {}
#endif
    ...
    virtual WTF::RefPtr<WebCore::PopupMenu> createPopupMenu(WebCore::PopupMenuClient&) const override;
    virtual WTF::RefPtr<WebCore::SearchPopupMenu> createSearchPopupMenu(WebCore::PopupMenuClient&) const override;
    ...
    virtual RefPtr<WebCore::Icon> createIconForFiles(const Vector<WTF::String>&);

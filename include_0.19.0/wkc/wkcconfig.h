 ...
 *  wkcconfig.h
 *
 *  Copyright(c) 2009-2018 ACCESS CO., LTD. All rights reserved.
 */
...
#ifndef NO_USE_JIT
//#define WKC_ENABLE_JIT 1
#endif

// accelerated compositing
#ifndef WKC_DISABLE_ACCELERATED_COMPOSITING
# define WKC_ENABLE_ACCELERATED_COMPOSITING 1
# define WKC_MAX_LAYERS 1024
# define WKC_ENABLE_COMPOSITED_FIXED_ELEMENTS 1
// position:fixed elements layout
# define WKC_FORCE_FIXED_ELEMENTS_NONFIXED_LAYOUT 1
#endif

// WebGL
#ifndef WKC_DISABLE_WEBGL
//# define WKC_ENABLE_WEBGL 1
#endif

// cairo
#define WTF_USE_WKC_CAIRO 1
#define USE_WKC_CAIRO 1
#define WKC_USE_WKC_OWN_CAIRO 1

...
const AtomicString& SVGFEConvolveMatrixElement::kernelUnitLengthXIdentifier()
{
    ...
    if (s_identifier.isNull())
        s_identifier.construct("SVGKernelUnitLengthX", AtomicString::ConstructFromLiteral);
#endif
    return s_identifier;
}
...
#if PLATFORM(WKC)
    if (s_identifier.isNull())
        s_identifier.construct("SVGKernelUnitLengthY", AtomicString::ConstructFromLiteral);
#endif
    return s_identifier;
}
...
#if PLATFORM(WKC)
    if (s_identifier.isNull())
        s_identifier.construct("SVGOrderX", AtomicString::ConstructFromLiteral);
#endif
    return s_identifier;
}
...
#if PLATFORM(WKC)
    if (s_identifier.isNull())
        s_identifier.construct("SVGOrderY", AtomicString::ConstructFromLiteral);
#endif
    return s_identifier;
}

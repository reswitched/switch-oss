...
#else
    bool isSupplemental() const { return m_isSupplemental; }
    void setIsSupplemental(bool isSupplemental) { m_isSupplemental = isSupplemental; }

...
WKCRect
NodePrivate::absoluteClippedCompositeTransformedRect() const
{
    WebCore::LayoutRect r = m_webcore->absoluteClippedCompositeTransformedRect();
...
WKCRect
Node::absoluteClippedCompositeTransformedRect() const
{
    return m_private.absoluteClippedCompositeTransformedRect();
}

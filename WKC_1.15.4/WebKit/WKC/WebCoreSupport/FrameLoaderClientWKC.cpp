...
PAL::SessionID
FrameLoaderClientWKC::sessionID() const
{
    notImplemented();
...
void
FrameLoaderClientWKC::dispatchWillPerformClientRedirect(const WebCore::URL& uri, double a, WallTime b)
{
...
void
FrameLoaderClientWKC::dispatchDidCommitLoad(std::optional<WebCore::HasInsecureContent>)
{
...
{
    m_appClient->dispatchDidReachLayoutMilestone((WKC::LayoutMilestones)milestones);
}
...
void
FrameLoaderClientWKC::dispatchDecidePolicyForNewWindowAction(const WebCore::NavigationAction& action, const WebCore::ResourceRequest& request, WebCore::FormState* state, const WTF::String& frame_name, WebCore::FramePolicyFunction&& function)
{
...
void
FrameLoaderClientWKC::dispatchDecidePolicyForNavigationAction(const WebCore::NavigationAction& action, const WebCore::ResourceRequest& request, const WebCore::ResourceResponse& redirectResponse, WebCore::FormState* state, WebCore::PolicyDecisionMode, WebCore::FramePolicyFunction&& function)
{
    WKC::FramePolicyFunctionPrivate* f = new WKC::FramePolicyFunctionPrivate(m_frame->core(), (void *)&function);
    ResourceRequestPrivate req(request);
    ...
    m_appClient->dispatchDecidePolicyForNavigationAction(*f, nav.wkc(), req.wkc(), res.wkc(), &st.wkc());
...
void
FrameLoaderClientWKC::dispatchWillSubmitForm(WebCore::FormState& state, WTF::Function<void(void)>&& function)
{
    WKC::FramePolicyFunctionPrivate* f = new WKC::FramePolicyFunctionPrivate(m_frame->core(), (void *)&function);
    FormStatePrivate st(&state);
...
void
FrameLoaderClientWKC::convertMainResourceLoadToDownload(WebCore::DocumentLoader* loader, PAL::SessionID, const WebCore::ResourceRequest& request, const WebCore::ResourceResponse& response)
{
    DocumentLoaderPrivate ldr(loader);
    ResourceRequestPrivate req(request);
    ResourceResponsePrivate res(response);
...
WebCore::ResourceError
FrameLoaderClientWKC::blockedByContentBlockerError(const WebCore::ResourceRequest& request)
{
    ResourceRequestPrivate req(request);
...
FrameLoaderClientWKC::objectContentType(const WebCore::URL& url, const WTF::String& mime)
{

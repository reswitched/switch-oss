...
public:
    static Ref<DatabaseProviderWKC> create(WKCWebViewPrivate*);
...
// Indexed database implementation is deleted temporary. 
// because IDBFactoryBackendInterface.h is deleted from WebCore.

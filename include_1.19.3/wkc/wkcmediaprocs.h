...
typedef bool (*wkcMediaPlayerSupportsSaveProc)(void* in_self);
...
typedef bool (*wkcMediaPlayerCanLoadPosterProc)(void* in_self);
typedef int (*wkcMediaPlayerSetPosterProc)(void* in_self, const char* in_poster);
...
struct WKCMediaPlayerProcs_ {
    ...
    wkcMediaPlayerSupportsSaveProc fSupportsSaveProc;
    ...
    wkcMediaPlayerCanLoadPosterProc fCanLoadPosterProc;
    wkcMediaPlayerSetPosterProc fSetPosterProc;

...
JSC::JSValue
JSQuickTimePluginReplacement::timedMetaData(JSC::JSGlobalObject&) const
{
    return JSC::JSValue(JSC::JSValue::JSUndefined);
}

JSC::JSValue
JSQuickTimePluginReplacement::accessLog(JSC::JSGlobalObject&) const
{
    return JSC::JSValue(JSC::JSValue::JSUndefined);
}

JSC::JSValue
JSQuickTimePluginReplacement::errorLog(JSC::JSGlobalObject&) const
{
    return JSC::JSValue(JSC::JSValue::JSUndefined);
}

...
Optional<WebCore::PageIdentifier>
...
Optional<WebCore::FrameIdentifier>
...
void
FrameLoaderClientWKC::dispatchDidCommitLoad(Optional<WebCore::HasInsecureContent>, Optional<WebCore::UsedLegacyTLS>)
{
...
FrameLoaderClientWKC::createFrame(const WTF::URL& url, const WTF::String& name, WebCore::HTMLFrameOwnerElement& ownerElement, const WTF::String& referrer)
{

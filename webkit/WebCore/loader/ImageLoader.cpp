...
static ImageEventSender& beforeLoadEventSender()
{
    ...
    return sender;
#else
    WKC_DEFINE_STATIC_PTR(ImageEventSender*, sender, new ImageEventSender(eventNames().beforeloadEvent));
    return *sender;
#endif
}
...
static ImageEventSender& loadEventSender()
{
    ...
    return sender;
#else
    WKC_DEFINE_STATIC_PTR(ImageEventSender*, sender, new ImageEventSender(eventNames().loadEvent));
    return *sender;
#endif
}
...
static ImageEventSender& errorEventSender()
{
    ...
    return sender;
#else
    WKC_DEFINE_STATIC_PTR(ImageEventSender*, sender, new ImageEventSender(eventNames().errorEvent));
    return *sender;
#endif
}

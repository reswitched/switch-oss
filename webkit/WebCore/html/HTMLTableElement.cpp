...
#else
            WKC_DEFINE_STATIC_PTR(StyleProperties*, solidBorderStyle, leakBorderStyle(CSSValueHidden));
#endif
...
#else
        WKC_DEFINE_STATIC_PTR(StyleProperties*, solidBorderStyle, leakBorderStyle(CSSValueSolid));
#endif
        return solidBorderStyle;
    }
#if !PLATFORM(WKC)
...
#else
    WKC_DEFINE_STATIC_PTR(StyleProperties*, outsetBorderStyle, leakBorderStyle(CSSValueOutset));
#endif
...
#else
        WKC_DEFINE_STATIC_PTR(StyleProperties*, rowBorderStyle, leakGroupBorderStyle(true));
#endif
...
#else
    WKC_DEFINE_STATIC_PTR(StyleProperties*, columnBorderStyle, leakGroupBorderStyle(false));
#endif

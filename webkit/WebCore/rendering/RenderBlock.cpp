...
#else
    WKC_DEFINE_STATIC_PTR(std::unique_ptr<DelayedUpdateScrollInfoStack>*, delayedUpdatedScrollInfoStack, 0);
    if (!delayedUpdatedScrollInfoStack) {
        delayedUpdatedScrollInfoStack = (std::unique_ptr<DelayedUpdateScrollInfoStack>*)fastMalloc(sizeof(std::unique_ptr<DelayedUpdateScrollInfoStack>*));
        delayedUpdatedScrollInfoStack = new (delayedUpdatedScrollInfoStack) std::unique_ptr<DelayedUpdateScrollInfoStack>();
    }
    return *delayedUpdatedScrollInfoStack;
#endif
}
...
#else
WKC_DEFINE_GLOBAL_PTR(RenderBlockRareDataMap*, gRareDataMap, 0);
#endif

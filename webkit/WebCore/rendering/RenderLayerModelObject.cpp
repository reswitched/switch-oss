...
#else
WKC_DEFINE_GLOBAL_CLASS_OBJ(bool, RenderLayerModelObject, s_wasFloating, false);
WKC_DEFINE_GLOBAL_CLASS_OBJ(bool, RenderLayerModelObject, s_hadLayer, false);
WKC_DEFINE_GLOBAL_CLASS_OBJ(bool, RenderLayerModelObject, s_hadTransform, false);
WKC_DEFINE_GLOBAL_CLASS_OBJ(bool, RenderLayerModelObject, s_layerWasSelfPainting, false);
#endif

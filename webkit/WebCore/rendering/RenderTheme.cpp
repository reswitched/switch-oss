...
#else
    WKC_DEFINE_STATIC_PTR(FontDescription*, caption, 0);
    WKC_DEFINE_STATIC_PTR(FontDescription*, icon, 0);
    WKC_DEFINE_STATIC_PTR(FontDescription*, menu, 0);
    WKC_DEFINE_STATIC_PTR(FontDescription*, messageBox, 0);
    WKC_DEFINE_STATIC_PTR(FontDescription*, smallCaption, 0);
    WKC_DEFINE_STATIC_PTR(FontDescription*, statusBar, 0);
    WKC_DEFINE_STATIC_PTR(FontDescription*, webkitMiniControl, 0);
    WKC_DEFINE_STATIC_PTR(FontDescription*, webkitSmallControl, 0);
    WKC_DEFINE_STATIC_PTR(FontDescription*, webkitControl, 0);
    WKC_DEFINE_STATIC_PTR(FontDescription*, defaultDescription, 0);
    if (!caption)
        caption = new FontDescription();
    if (!icon)
        icon = new FontDescription();
    if (!menu)
        menu = new FontDescription();
    if (!messageBox)
        messageBox = new FontDescription();
    if (!smallCaption)
        smallCaption = new FontDescription();
    if (!statusBar)
        statusBar = new FontDescription();
    if (!webkitMiniControl)
        webkitMiniControl = new FontDescription();
    if (!webkitSmallControl)
        webkitSmallControl = new FontDescription();
    if (!webkitControl)
        webkitControl = new FontDescription();
    if (!defaultDescription)
        defaultDescription = new FontDescription();

...
#else
    WKC_DEFINE_STATIC_PTR(Bitmap<256>*, doNotUnescapeWhenDecodingURI, new Bitmap<256>);
...
#else
    WKC_DEFINE_STATIC_PTR(Bitmap<256>*, emptyBitmap, new Bitmap<256>);
    return JSValue::encode(decode(exec, *emptyBitmap, true));
#endif
}
...
#else
    WKC_DEFINE_STATIC_PTR(Bitmap<256>*, doNotEscapeWhenEncodingURI, new Bitmap<256>);
...
#else
    WKC_DEFINE_STATIC_PTR(Bitmap<256>*, doNotEscapeWhenEncodingURIComponent, new Bitmap<256>);
...
#else
    WKC_DEFINE_STATIC_PTR(Bitmap<256>*, doNotEscape_, new Bitmap<256>);

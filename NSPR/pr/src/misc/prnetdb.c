...
#if (defined(__GLIBC__) && __GLIBC__ >= 2 && !defined(XP_BEOS) && !defined(NN_NINTENDO_SDK))
#define _PR_HAVE_GETPROTO_R
#define _PR_HAVE_5_ARG_GETPROTO_R
#endif
...
#define GETHOSTBYNAME(name)               nnsocketGetHostByName(name)
#define GETHOSTBYNAME2(name, af)          NULL
#define GETHOSTBYADDR(addr, addrlen, af)  nnsocketGetHostByAddr(addr, addrlen, af)

...
/*  Use the value from nn:os:MemoryPageSize, declared in
    nn/os/os_MemoryHeapCommon.h.  Cannot directly include it here since
    it is in C++ object namespace.  */
#define NNSDK_PAGE_SIZE                 4096
#endif

...
#if defined(XP_UNIX) || defined(XP_WIN32) || defined(XP_OS2) || defined(XP_BEOS) || defined(NN_NINTENDO_SDK)
...
#if (defined(_WIN32) || defined(XP_OS2)) && !defined(NN_NINTENDO_SDK)

#define DEFAULT_CACHE_DIRECTORY "\\temp"

#endif /* _win32 */

#if (defined(XP_UNIX) || defined(XP_BEOS)) && !defined(NN_NINTENDO_SDK)
...
#define DEFAULT_CACHE_DIRECTORY "/temp/ssl"
...
/* Create file names */
        ...
        */
        ...
        cfn = PR_smprintf("@System:%s/svrcache.ssl", directory);
#else

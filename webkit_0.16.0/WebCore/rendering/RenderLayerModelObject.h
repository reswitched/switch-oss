...
#else
    WKC_DEFINE_GLOBAL_CLASS_OBJ_ENTRY(bool, s_wasFloating);
    WKC_DEFINE_GLOBAL_CLASS_OBJ_ENTRY(bool, s_hadLayer);
    WKC_DEFINE_GLOBAL_CLASS_OBJ_ENTRY(bool, s_hadTransform);
    WKC_DEFINE_GLOBAL_CLASS_OBJ_ENTRY(bool, s_layerWasSelfPainting);
#endif
};

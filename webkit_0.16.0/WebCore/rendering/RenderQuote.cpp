...
#else
    WKC_DEFINE_STATIC_PTR(StringImpl*, quotationMarkString, stringForQuoteCharacter(quotationMark));
#endif
...
#else
    WKC_DEFINE_STATIC_PTR(StringImpl*, apostropheString, stringForQuoteCharacter(apostrophe));
#endif

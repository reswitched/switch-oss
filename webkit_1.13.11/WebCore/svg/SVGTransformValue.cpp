...
#if PLATFORM(WKC)
        if (matrixString.isNull())
            matrixString.construct(MAKE_STATIC_STRING_IMPL("matrix("));
#endif
        return matrixString;
    }
...
#if PLATFORM(WKC)
        if (translateString.isNull())
            translateString.construct(MAKE_STATIC_STRING_IMPL("translate("));
#endif
...
#if PLATFORM(WKC)
        if (scaleString.isNull())
            scaleString.construct(MAKE_STATIC_STRING_IMPL("scale("));
#endif
        return scaleString;
    }
...
#if PLATFORM(WKC)
        if (rotateString.isNull())
            rotateString.construct(MAKE_STATIC_STRING_IMPL("rotate("));
#endif
        return rotateString;
    }    
...
#if PLATFORM(WKC)
        if (skewXString.isNull())
            skewXString.construct(MAKE_STATIC_STRING_IMPL("skewX("));
#endif
        return skewXString;
    }
...
#if PLATFORM(WKC)
        if (skewYString.isNull())
            skewYString.construct(MAKE_STATIC_STRING_IMPL("skewY("));
#endif
        return skewYString;
    }
    }
